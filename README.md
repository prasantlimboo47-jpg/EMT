...
Ampere’s Law for magnetic field due to current

Biot–Savart Law for magnetic field calculation

Gauss’s Law for electric flux

Maxwell’s Equation in one dimension (1D)

Maxwell’s Equation in two dimensions (2D)
...
include: Contains all header files declaring functions and constants

src: Contains source files implementing the declared functions
...
Understand electromagnetic laws through programming

Learn how to organize a C++ library

Practice manual compilation using a compiler
